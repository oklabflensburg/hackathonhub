  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      ...
      <div v-else-if="hackathon" class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="h-48 relative">
          ...
          <div 
            v-else 
            class="absolute inset-0 bg-gradient-to-r from-primary-500 to-purple-600"
          >
        ...
        <div class="p-8">
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
              ...
              <div v-if="hackathon.latitude && hackathon.longitude" class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 sm:p-5 lg:p-6 mb-6">
                ...
                <div class="aspect-video rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600">
                  <iframe 
                    ...
                    :title="`Map of ${hackathon.name} location`"
                    class="w-full h-full"
                  >
                  </iframe>
                </div>
                <div class="mt-3 text-sm text-gray-600 dark:text-gray-400">
                  <a 
                    :href="`https://www.openstreetmap.org/?mlat=${hackathon.latitude}&mlon=${hackathon.longitude}#map=16/${hackathon.latitude}/${hackathon.longitude}`" 
                    target="_blank" 
              ...
              <!-- Actions -->
              <div class="space-y-4">
                <div v-if="hackathon.status === 'active' || hackathon.status === 'upcoming'">
                  <button
                    v-if="!isRegistered"
                    class="w-full btn btn-primary"
                    @click="registerForHackathon"
          ...
          <div class="p-4 sm:p-5 lg:p-6">
            ...
            <form @submit.prevent="saveEdit" class="space-y-4">
              ...
              <div>
                ...
                <div class="space-y-3">
                  <div 
                    v-for="(prize, index) in editForm.prizes" 
                    :key="index"
              ...
              <div>
                ...
                <div class="space-y-3">
                  <div 
                    v-for="(organizer, index) in editForm.organizers" 
                    :key="index"
                    class="p-3 border border-gray-300 dark:border-gray-600 rounded-lg"
                  >
                    <div class="flex justify-between items-start mb-2">
...
const editHackathon = async () => {
  ...
  // Initialize edit form with current hackathon data
  editForm.value = {
    ...
    prize_pool: hackathon.value.prize_pool || '5000' // Use real API data or default
  }
}
