<template>
  <div class="py-8">
    ...
    <div class="mb-8">
      ...
      <p class="text-gray-600 dark:text-gray-400">Manage your account settings and personal information</p>
    </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
          ...
          <div v-else-if="user" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              <div>
                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">GitHub Account</h4>
                <div class="flex items-center space-x-3">
                  ...
                  <span class="text-gray-900 dark:text-white">{{ user?.username || 'Not connected' }}</span>
                  <span v-if="user?.username" class="ml-2 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300">
                    Connected
                  </span>
                </div>
              </div>
              ...
              <div>
                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Account Type</h4>
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-300">
                  {{ (user as any).is_admin ? 'Administrator' : 'Standard User' }}
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-3">
            ...
            >
              <div class="flex items-center space-x-3">
                ...
                <span class="font-medium text-primary-700 dark:text-primary-300">Create Hackathon</span>
              </div>
              <svg class="w-5 h-5 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <div class="flex items-center space-x-3">
                ...
                <span class="font-medium text-gray-700 dark:text-gray-300">View My Projects</span>
              </div>
              <svg class="w-5 h-5 text-gray-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
              </svg>
            ...
            >
              <div class="flex items-center space-x-3">
                ...
                <span class="font-medium text-gray-700 dark:text-gray-300">View My Votes</span>
              </div>
              <svg class="w-5 h-5 text-gray-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
              </svg>
