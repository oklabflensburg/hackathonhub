    ...
    <div v-if="activeTab === 'project'" class="space-y-6">
      <div class="card">
        ...
        <form @submit.prevent="submitProject" class="space-y-6">
          ...
          <!-- Team Selection -->
          <div v-if="projectForm.hackathonId">
            <label class="label">{{ $t('create.projectForm.fields.team') || 'Team' }}</label>
            <TeamSelection
              :hackathon-id="projectForm.hackathonId"
          ...
          <div v-else class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <div class="flex items-center mb-2">
              ...
              <h4 class="font-medium text-blue-800 dark:text-blue-300">{{ $t('create.projectForm.fields.teamSelected') }}</h4>
            </div>
...
onMounted(() => {
  ...
  const hackathonParam = route.query.hackathon as string
  const teamParam = route.query.team as string
  
  if (hackathonParam) {
    projectForm.value.hackathonId = hackathonParam
  }
  
  if (teamParam) {
    projectForm.value.teamId = parseInt(teamParam) || null
  }
})
...
const submitProject = async () => {
  ...
  try {
    ...
    const projectData = {
      ...
      team_id: projectForm.value.teamId || null,
