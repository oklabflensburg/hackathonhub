      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
          ...
          <NuxtLink to="/" class="flex items-center space-x-3">
            ...
            <div>
              <h1 class="text-xl font-bold text-gray-900 dark:text-white">Hackathon Hub</h1>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div v-if="isAuthenticated" class="relative">
            ...
            >
              <div class="relative">
                <div v-if="authStore.user?.avatar_url" class="w-10 h-10 rounded-full overflow-hidden border-2 border-white dark:border-gray-800">
                  <img
                ...
                <div v-else class="w-10 h-10 rounded-full bg-primary-100 dark:bg-primary-900 flex items-center justify-center border-2 border-white dark:border-gray-800">
            ...
            <div
              v-if="userMenuOpen"
              class="absolute right-0 mt-2 w-56 sm:w-64 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50 animate-slide-in"
            >
              ...
              <div @click="userMenuOpen = false">
                <NuxtLink 
                  to="/profile" 
                  class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                >
              ...
              <div class="border-t border-gray-100 dark:border-gray-700 mt-2 pt-2">
                <button
                  @click="handleLogout"
                  class="flex items-center w-full px-4 py-3 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
                >
                  <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
