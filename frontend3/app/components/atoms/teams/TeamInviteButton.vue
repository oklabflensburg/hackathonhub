<template>
  ...
  >
    ...
    <span v-if="loading" class="flex items-center justify-center">
      ...
      <span>{{ loadingText || $t('teams.actions.inviting') }}</span>
    </span>
    ...
    <span v-else class="flex items-center">
      ...
      <span>{{ label || $t('teams.actions.inviteMembers') }}</span>
    </span>
  </button>
</template>
...
import type { TeamInviteButtonProps } from '~/types/team-types'

const props = withDefaults(defineProps<TeamInviteButtonProps & {
...
const computedAriaLabel = computed(() => {
  ...
  if (props.loading) return props.loadingText || 'Inviting members to team'
  return props.label || 'Invite members to team'
})
</script>
