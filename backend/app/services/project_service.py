...
class ProjectService:
    ...
    def create_project(
        ...
        project = self.project_repo.create(db, project_data)
        return ProjectSchema.model_validate(project)
    ...
    def update_project(
        ...
        updated_project = self.project_repo.update(db, project, update_data)
    ...
    def delete_project(self, db: Session, project_id: int) -> bool:
        ...
        self.project_repo.delete(db, project_id)
        return True
    ...
    def add_vote(
        self, db: Session, project_id: int, user_id: int, vote_type: str = "upvote"
    ) -> Optional[VoteSchema]:
        ...
        vote = self.vote_repo.create(db, vote_data)
    ...
    def remove_vote(self, db: Session, project_id: int, user_id: int) -> bool:
        ...
        self.vote_repo.delete(db, vote.id)
        return True
    ...
    def add_comment(
        ...
        comment = self.comment_repo.create(db, comment_data)
    ...
    def delete_comment(
        ...
        self.comment_repo.delete(db, comment_id)
        return True
