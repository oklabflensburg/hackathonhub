...
class TeamService:
    ...
    def create_team(
        ...
        team = self.team_repo.create(db, team_data)
    ...
    def update_team(
        ...
        updated_team = self.team_repo.update(db, team, update_data)
    ...
    def add_team_member(
        ...
        member = self.member_repo.create(db, member_data)
    ...
    def remove_team_member(
        ...
        self.member_repo.delete(db, member.id)
        return True
    ...
    def create_team_invitation(
        ...
        invitation = self.invitation_repo.create(db, invitation_data)
